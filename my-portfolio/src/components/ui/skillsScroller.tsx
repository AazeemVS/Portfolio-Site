...
const SkillsScroller: React.FC<SkillsScrollerProps> = ({ icons }) => (
  <div className="flex justify-center items-center relative bg-[#111111]">
    ...
    <div
      className="absolute inset-y-0 left-0 w-20 bg-gradient-to-r from-[#111111] to-transparent z-10 pointer-events-none"
    />
    <div
      className="absolute inset-y-0 right-0 w-20 bg-gradient-to-l from-[#111111] to-transparent z-10 pointer-events-none"
    />
    ...
    <div
      ...
      style={{
        maskImage:      'linear-gradient(90deg, transparent 0%, #111111 15%, #111111 85%, transparent 100%)',
        WebkitMaskImage:'linear-gradient(90deg, transparent 0%, #111111 15%, #111111 85%, transparent 100%)',
      }}
    >
