...
const LandingPage: React.FC = () => (
 ...
 <Card>
  ...
  <CardContent>
    <p>Hey I'm Aazeem, I'm a 19 year old full stack web, software, and game developer. I have been programming for 3 years, and I enjoy expressing my creativity and bringing ideas to life online.</p>
  </CardContent>
</Card>
 ...
 {/* Title */}
      <div className="text-left">
        <h2 className="text-white text-5xl font-bold">My Skills</h2>
          ...
          <SkillsScroller icons={[ViteIcon, GitIcon, NodeJSIcon, JavaIcon, TailwindCSSIcon]} />
          <SkillsScroller icons={[ShadcnIcon, CPlusPlusIcon, AngularIcon, CSharpIcon, FigmaIcon]} />
    </div>
  </div>
</section>
