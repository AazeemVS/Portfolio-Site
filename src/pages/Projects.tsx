  ...
  return (
    <>
      ...
      <Card id="web-projects" className="border-none bg-transparent">
        <PageTitle className="text-left">Web Projects</PageTitle>
      </Card>
      <div className="flex flex-col gap-10 md:gap-20">
        ...
        <ProjectTemplate
          ...
          // override the defaults if you like, or omit this prop to get the 3-icon default
          icons={[<JSIcon key="1" />, <HTMLIcon key="3" />, <CSSIcon key="4" />]}
          to="/CatchFrenzyInfoPage"
        />
      </div>
      <Card id="game-projects" className="border-none bg-transparent">
        <PageTitle className="text-left">Game Projects</PageTitle>
      </Card>
